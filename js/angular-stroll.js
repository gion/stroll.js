    ...
    angular
        ...
        .directive('stroll', function() {
            ...
            function link(scope, elem, attrs) {
                ...
                if(attrs.stroll === 'live') {
                    options.live = true;
                }

                // a simple trigger
                // it can be an expression (or simpler a counter)
                // that should trigger the stroll to recalculate sizes
                // NOTE: it shuoldn't be used if the live option is passed
                attrs.$observe('strollRefreshTrigger', function() {
                    bindStroll();
                });

                function bindStroll() {
                    stroll.bind(elem, options);
                }
 ...
 */
 ...
 // adapted (well..fine.. butchered :( the code)
 // sry, hakimel!
var stroll = (function(){
